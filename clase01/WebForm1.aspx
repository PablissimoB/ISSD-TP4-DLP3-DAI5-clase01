    ...
    <form id="form1" runat="server">
        <div>
            ...
            *<asp:Label ID="Label2" runat="server" Text="Nombre"></asp:Label>
            ...
            <br />
            *Estado Civil: <asp:RadioButton ID="RadioButton1" runat="server" Text="Casado/a" GroupName="rdButtons" />
        ...
        <br />
            <br />
            *Pais<br />
        <asp:DropDownList ID="DropDownList1" runat="server" AutoPostBack="True" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged" Height="22px" Width="170px">
        </asp:DropDownList>
        <br />
        <br />
        ¿A que provincia le gustaría viajar?<br />
        <br />
        <asp:ListBox ID="ListBox1" runat="server" Width="104px" SelectionMode="Multiple"></asp:ListBox>
        <br />
            </div>
        <br />
